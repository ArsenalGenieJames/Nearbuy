...
<html>
  ...
  <body>  
    ...
    <div class="w-full md:w-1/2 flex flex-col justify-center items-center bg-gray-100 p-8 h-screen">
      ...
      <form  id="login-form" class="w-full max-w-sm mt-2">
      <div class="mb-4">
        <input id="phonenumber" type="text" class="w-full p-2 border border-gray-300 rounded" placeholder="Phone number" required>
      </div>
      <div class="mb-4">
        <input type="password" id="password-login" class="w-full p-2 border border-gray-300 rounded" placeholder="Enter password" required>
      </div>
